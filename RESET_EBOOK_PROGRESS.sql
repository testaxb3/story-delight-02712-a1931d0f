-- ==========================================
-- RESET USER EBOOK PROGRESS TABLE
-- ==========================================
-- Execute este SQL no Supabase Dashboard
-- ATENÇÃO: Vai apagar todos os dados de progresso dos ebooks!
-- ==========================================

-- Drop existing table and recreate from scratch
DROP TABLE IF EXISTS user_ebook_progress CASCADE;
...
-- Create indexes
CREATE INDEX idx_user_ebook_progress_user_id ON user_ebook_progress(user_id);
CREATE INDEX idx_user_ebook_progress_ebook_id ON user_ebook_progress(ebook_id);
CREATE INDEX idx_user_ebook_progress_last_read ON user_ebook_progress(user_id, last_read_at DESC);

-- Helper function: mark chapter as complete
...
-- Helper function: update reading time
...
-- ✅ Should see: table exists + 4 policies (SELECT, INSERT, UPDATE, DELETE)
