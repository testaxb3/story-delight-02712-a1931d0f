...
-- ==========================================
-- Ensures table exists with correct structure and RLS policies
...
DO $$
BEGIN
  RAISE NOTICE '✅ user_ebook_progress table fixed with RLS policies';
  RAISE NOTICE '✅ Helper functions created: mark_chapter_complete, update_reading_time, add_bookmark';
END $$;
