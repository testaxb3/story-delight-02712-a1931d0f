-- Create script_feedback table to track script outcomes
...
CREATE INDEX IF NOT EXISTS idx_script_feedback_user_child ON script_feedback(user_id, child_id);
CREATE INDEX IF NOT EXISTS idx_script_feedback_script_outcome ON script_feedback(script_id, outcome);
CREATE INDEX IF NOT EXISTS idx_script_feedback_created_at ON script_feedback(created_at DESC);
