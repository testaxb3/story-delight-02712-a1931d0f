-- SCREENS - DISTRACTED PROFILE (FIXED STRUCTURE)
...
→ Time blindness is a core ADHD symptom. They physically can''t track time while hyperfocused.',
  ...
  '[
    ...
    {
      "step_number": 2,
      "step_title": "Body-Based Countdown (Last 60 Seconds)",
    ...
    {
      "step_number": 3,
      "step_title": "Immediate Handoff + Dopamine Bridge",
