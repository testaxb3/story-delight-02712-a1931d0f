  ...
  return (
    <MainLayout hideSideNav>
      ...
      >
        ...
        >
          <h1 className="text-3xl font-bold text-white tracking-tight font-relative">Cal AI</h1>
          <motion.div 
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            onClick={() => navigate('/tracker')}
            className="flex items-center gap-2 bg-[#1C1C1E]/80 backdrop-blur-md border border-white/5 px-4 py-2 rounded-full shadow-lg cursor-pointer"
          >
        ...
        >
          ...
          >
            <motion.div 
              ...
              whileTap={{ scale: 0.98 }}
              onClick={() => navigate('/tracker')}
              className="h-full bg-[#1C1C1E] border border-[#333] rounded-[32px] p-6 flex flex-col justify-between relative overflow-hidden group cursor-pointer"
            >
          ...
          {[...Array(totalCarouselCards)].map((_, index) => (
            <motion.div
              ...
              animate={{
                ...
                backgroundColor: activeCarouselIndex === index ? '#ffffff' : '#333333'
              }}
              transition={{ duration: 0.3 }}
        ...
        {dashboardStats?.recentScriptUsage && dashboardStats.recentScriptUsage.length > 0 && (
          <RecentActivitySection 
            ...
            onScriptClick={() => navigate('/scripts')}
          />
        )}
