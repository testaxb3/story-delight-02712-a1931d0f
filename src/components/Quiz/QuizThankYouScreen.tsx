...
export const QuizThankYouScreen = ({ onContinue }: QuizThankYouScreenProps) => {
  ...
  return (
    <motion.div
      ...
      className="min-h-screen flex flex-col bg-white dark:bg-black pt-[env(safe-area-inset-top)]"
    >
      {/* Progress Bar */}
      <div className="fixed top-[env(safe-area-inset-top)] left-0 right-0 z-50 bg-white dark:bg-black">
