...
export const PremiumBackground = memo(function PremiumBackground() {
  ...
  return (
    <div className="fixed inset-0 overflow-hidden">
      ...
      {/* Aurora orbs - organic, slow, mesmerizing - INCREASED VISIBILITY */}
      <AuroraOrb
        className="absolute -top-1/4 -left-1/4 w-[800px] h-[800px] rounded-full bg-gradient-to-br from-orange-500/20 via-rose-500/15 to-pink-500/10 blur-[80px]"
        delay={0}
        duration={25}
        scale={1}
      />
      <AuroraOrb
        className="absolute top-1/3 -right-1/4 w-[600px] h-[600px] rounded-full bg-gradient-to-bl from-violet-500/18 via-indigo-500/12 to-purple-500/8 blur-[70px]"
        delay={5}
        duration={30}
        scale={1.1}
      />
      <AuroraOrb
        className="absolute -bottom-1/4 left-1/4 w-[700px] h-[700px] rounded-full bg-gradient-to-tr from-cyan-500/15 via-teal-500/10 to-blue-500/8 blur-[75px]"
        delay={10}
        duration={28}
        scale={0.9}
      />

      {/* Subtle spotlight from top - INCREASED */}
      <div
