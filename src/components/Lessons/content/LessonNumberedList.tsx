          ...
          <div className="space-y-4">
            {data.items.map((item, index) => (
              ...
              >
                ...
                {/* Card */}
                <div className="bg-gradient-to-r from-[#FFF9F5] to-white p-4 rounded-[14px] border border-[#FFE4D1] shadow-sm hover:shadow-md transition-shadow">
                  <h4 className="font-bold text-[#393939] text-[15px] mb-1">
                    {item.title}
                  </h4>
                  {item.description && (
